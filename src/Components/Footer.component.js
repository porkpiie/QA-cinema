...
export default class AppFooter extends Component {
    render(){
  return (
    <MDBFooter color="black" className="font-small lighten-3 pt-4 mt-4">
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="my-4">
          ...
          <MDBCol md="2" lg="2" className="text-center">
            ...
            <div className="mt-2 ">
              <a type="button" className="btn-floating btn-small btn-fb" href="#!">
                <i className="fab fa-facebook-f" />
              </a>
              <a type="button" className="btn-floating btn-small btn-tw" href="#!">
